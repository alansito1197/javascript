          ...
          <div class="row d-flex justify-content-center align-items-center">
            ...
            <div class="row">
              <div class="col-md-6 text-center">
                <form id="resenaForm">
                  <input type="text" class="contenedor_informacion_login" name="nombreUsuario" id="nombreUsuario" disabled readonly>
                    <?php
                      if (isset($_SESSION['nombre'])) {
                        echo '<script>document.getElementById("nombreUsuario").value = "' . $_SESSION['nombre'] . '";</script>';
                      }
                    ?>
