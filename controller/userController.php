                ...
                if (!empty($_POST['usuario']) && !empty($_POST['password'])){
                    ...
                    if ($usuario !== null){
                        ...
                        if ($password == $usuario->password) {
                           ...
                           // Almacenamos el nombre del usuario en la variable de sesión 'nombre' según el tipo de usuario:
                            if ($_SESSION['tipo_usuario'] == 'administrador') {
                                $_SESSION['nombre'] = $usuario->getNombre(); // Suponiendo que la clase Administrador tiene un método getNombre()
                            } elseif ($_SESSION['tipo_usuario'] == 'cliente') {
                                $_SESSION['nombre'] = $usuario->getNombre(); // Suponiendo que la clase Cliente tiene un método getNombre()
                            }
