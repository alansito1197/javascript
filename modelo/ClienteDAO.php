<?php
    ...
    class ClienteDAO {
        ...
        // Crearemos una función para obtener la contraseña del cliente mediante su I
            public static function getPasswordCliente($usuario_id) {
                // Nos conectamos a la base de datos:
                $conexion = DataBase::connect();
            
                // Crearemos una consulta para obtener la contraseña del cliente:
                ...
                if ($resultado->num_rows > 0) {
                    ...
                    $fila = $resultado->fetch_object('Cliente');
        
                    // Devolvemos el objeto Cliente, incluyendo la propiedad de contraseña
                    return $fila;
                } 
            }
